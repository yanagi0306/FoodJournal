...
trait FetchesCompanyInfoTrait
{
    ...
    {
        $this->stores = $this->company->stores->toArray();
    }
    ...
    {
        $this->customerTypes = $this->company->customerTypes->toArray();
    }
    ...
    {
        $this->paymentMethods = $this->company->paymentMethods->toArray();
    }
    ...
    {
        $this->purchaseSuppliers = $this->company->purchaseSuppliers->toArray();
    }
    ...
    {
        $this->incomeCategories = $this->company->incomeCategories->toArray();
    }
    ...
    {
        $this->expenseCategories = $this->company->expenseCategories->toArray();
    }
}
