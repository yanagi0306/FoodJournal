...
class CommonDatabaseConstants
{
     ...
     */
    // 全てのカテゴリコードは「10」から採番されるものとする
    const START_CATEGORY_CODE = 10;

    // 親支出カテゴリに紐づく支出カテゴリの最大値(特殊値除く)
    const MAX_EXPENSE_CATEGORY_CODE = 19;

    // 会社に紐づく親支出カテゴリの最大値(特殊値除く)
    const MAX_PARENT_EXPENSE_CATEGORY_CODE = 49;
